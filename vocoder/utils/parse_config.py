...
from vocoder import text_encoder as text_encoder_module
from vocoder.base.base_text_encoder import BaseTextEncoder
from vocoder.logger import setup_logging
from vocoder.text_encoder import CTCCharTextEncoder
...
class ConfigParser:
    ...
    def get_default_configs(cls):
        config_path = ROOT_PATH / "vocoder" / "config.json"
        with config_path.open() as f:
            return cls(json.load(f))

    @classmethod
    def get_test_configs(cls):
        config_path = ROOT_PATH / "vocoder" / "tests" / "config.json"
        with config_path.open() as f:
            return cls(json.load(f))
